        ...
        <div class="flex h-screen">
            ...
            <div class="w-full bg-gray-100 lg:w-1/2 flex items-center justify-center">
                <div class="max-w-md w-full p-6">
                    <h1 class="text-3xl font-semibold mb-4 text-black text-center">FutbolPass</h1>
                    <h1 class="text-2xl font-semibold mb-6 text-black text-center">Crear cuenta de Jugador</h1>
                    <h1 class="text-sm font-semibold mb-6 text-gray-500 text-center">Ingresa tus datos</h1>
                    ...
                    <div class="mt-4 text-sm text-gray-600 text-center">
                        <p>¿Ya tienes cuenta? <a href="{{ route('login') }}" class="text-black hover:underline">Inicia
                                sesión aquí</a>
                        </p>
                    </div>
                </div>
