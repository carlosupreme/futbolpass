<div>
    <button type="button" class="flex items-center mx-3 text-sm rounded-full md:mr-0 " id="user-menu-button"
        ...
        <div class="relative overflow-hidden bg-gray-100 rounded-full ring-2 ring-gray-300 dark:bg-gray-600">
            <img class="w-9 h-9 p-0.5 rounded-full" src="{{Auth::user()->profile_photo_url}}" alt="{{Auth::user()->name}}" >
        </div>
    ...
    <!-- Dropdown menu -->
    <div class="hidden z-50 my-4 w-64 text-base list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 rounded-xl"
        id="dropdown">
