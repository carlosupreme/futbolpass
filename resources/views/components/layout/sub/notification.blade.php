<button data-dropdown-toggle="notification-dropdown"
    class="inline-flex items-center p-1 pr-0 mr-1 text-gray-500 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-700 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600"
    type="button">
    ...
    <span
        class="relative inline-flex w-4 h-4 bg-red-500 border-2 border-white rounded-full -top-2 right-3 dark:border-gray-900">
    </span>
</button>
